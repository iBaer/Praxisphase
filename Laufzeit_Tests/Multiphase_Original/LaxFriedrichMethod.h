...
class LaxFriedrichMethod : public numerische_methode
{
    public:
        ...
        */
        LaxFriedrichMethod(std::string const_in, std::string formel_in, std::string winkel_in, std::string kreis_in, std::string save_in);
    protected:
        /**
        * Berechnung des Lax-Friedrich Flusses.
        * @return Das zurückgelieferte Objekt ist ein Vektor mit 4 Dimensionen (Formel,Raster x-Koordinate,Raster y-Koordinate,Flussrichtung)
        */
