...
class Raster
{
    public:
        ...
        */
        Raster(Konstanten konstanten, std::string winkel_in, std::string kreis_in, std::string save_in);
        /**
        ...
        * @param konstanten Konstanten wo festgelegt ist welche Randbedingungen angewendet werden.
        */
